...
/**
 * The osapi_IO_Provider_LocalHttp class is used to define a mock HTTP layer that
 * returns a pre-defined response.
 *
 * @author Dan Holevoet
 */
class osapi_IO_Provider_LocalHttp extends osapi_IO_Provider_Http {
  protected $responses;
  protected $request;
  ...
  public function send($url, $method, $postBody = false, $headers = false, $ua = self::USER_AGENT) {
    ...
    osapi_Logger::info($this->request);
