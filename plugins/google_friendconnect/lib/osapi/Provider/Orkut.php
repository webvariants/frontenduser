 ...
 * @author Chris Chabot
 */
class osapi_Provider_Orkut extends osapi_Provider {
   ...
   * @param osapi_Request $request The request to adjust.
   */
  public function fixFields(osapi_Request &$request) {
   ...
   * @param osapi_Request $request The request to adjust.
   */
  public function fixViewer(osapi_Request &$request, &$url) {
    if ($request->method == 'appdata.create' ||
        $request->method == 'appdata.update' ||
