 ...
 * @author Chris Chabot
 */
class osapi_Service_People extends osapi_Service {
  ...
  public function get($params) {
    return osapi_Request::createRequest('people.get', $params);
  }
  ...
  public function getSupportedFields() {
    return osapi_Request::createRequest('people.getSupportedFields', array('userId' => '@supportedFields'));
  }
  ...
  public function getViewer($params) {
    return osapi_Request::createRequest('people.get', array_merge(array('userId' => '@viewer'), $params));
  }
  ...
  {
    throw new osapi_Exception("Updating people is not supported");
  }

  public function delete($params)
  {
    throw new osapi_Exception("Deleting people is not supported");
  }

  public function create($params)
  {
    throw new osapi_Exception("Creating people is not supported");
  }
  ...
  static public function convertarray($array, $strictMode = true) {
    ...
    $person = new osapi_Model_Person($id, $name);
