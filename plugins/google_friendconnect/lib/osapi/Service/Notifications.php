 ...
 */
class osapi_Service_Notifications extends osapi_Service {
  /**
  ...
  */
  public function getSupportedFields() {
    throw new osapi_Exception("@supportedFields for notifications is not supported");
  }
  ...
  */
  public function get($params) {
    throw new osapi_Exception("Fetching notifications is not supported");
  }
  /**
  ...
  */
  public function update($params) {
    throw new osapi_Exception("Updating notifications is not supported");
  }

  public function delete($params) {
    throw new osapi_Exception("Deleting notifications is not supported");
  }

  public function create($params) {
    $params = array_merge($params, array('userId'=>'@me', 'groupId'=>'@self'));
    return osapi_Request::createRequest('notifications.create', $params);
  }
  ...
  */
  static public function convertArray($array, $strictMode = true) {
    $instance = new osapi_Model_Notification();
    $defaults = get_class_vars('osapi_Model_Notification');

    if ($strictMode && sizeof($defaults != sizeof($array))) {
        throw new osapi_Exception("Unexpected fields in notifications response". print_r($array, true));
    }
