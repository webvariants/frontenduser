 ...
 * @author Chris Chabot
 */
class osapi_Service_System extends osapi_Service {
  ...
  public function listMethods() {
    return osapi_Request::createRequest('system.listMethods', array());
  }

  public function get($params) {
    throw new osapi_Exception("osapi_Service_System only supports the invalidate method");
  }
