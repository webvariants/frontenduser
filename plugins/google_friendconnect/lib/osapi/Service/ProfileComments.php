 ...
 */
class osapi_Service_ProfileComments extends osapi_Service {
  /**
  ...
  public function get($params)
  {
      ...
      return osapi_Request::createRequest('profilecomments.get', $params);
  }
  /**
  ...
  {
      throw new osapi_Exception("Updating this endpoint is not supported");
  }
