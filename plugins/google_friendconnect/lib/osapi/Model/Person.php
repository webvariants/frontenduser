...
class osapi_Model_Person {
  ...
  public function setLookingFor($lookingFor) {
    $this->setFieldImpl('lookingFor', new osapi_Model_Enum_LookingFor($lookingFor));
  }
  ...
  public function setNetworkPresence($networkPresence) {
    $this->setFieldImpl('networkPresence', new osapi_Model_Enum_Presence($networkPresence));
  }
  ...
  public function setSmoker($smoker) {
    $this->setFieldImpl('smoker', new osapi_Model_Enum_Smoker($smoker));
  }
