 ...
 * @author Chris Chabot
 */
class osapi_Auth_OAuth_2Legged extends osapi_Auth {
  ...
  public function sign($method, $url, $params = array(), $postBody = false, &$headers = array()) {
    $oauthRequest = OAuth_Request::from_request($method, $url, $params);
  ...
  protected function mergeParameters($params) {
    $defaults = array(
      ...
      'oauth_version' => OAuth_Request::$version, 'oauth_timestamp' => time(),
