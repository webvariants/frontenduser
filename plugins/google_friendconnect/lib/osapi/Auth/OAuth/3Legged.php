 ...
 * @author Chris Chabot
 */
class osapi_Auth_OAuth_3Legged extends osapi_Auth_OAuth_2Legged {
  protected $userId;
  ...
  protected function requestAccessToken($requestToken, $requestTokenSecret) {
    ...
    $accessRequest = OAuth_Request::from_consumer_and_token($this->consumerToken, $accessToken, "GET", $this->provider->accessTokenUrl, array());
  ...
  protected function requestRequestToken() {
    ...
    $requestTokenRequest = OAuth_Request::from_consumer_and_token($this->consumerToken, NULL, "GET", $this->provider->requestTokenUrl, $requestParams);
