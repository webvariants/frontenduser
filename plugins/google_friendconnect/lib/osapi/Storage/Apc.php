 ...
 * @author Chris Chabot
 */
class osapi_Storage_Apc extends osapi_Storage {

  public function __construct() {
    if (! function_exists('apc_add')) {
      throw new osapi_Storage_Exception("Apc functions not available");
    }
  }
  ...
  public function set($key, $value) {
    if (@apc_store($key, array('time' => time(), 'data' => serialize($value))) == false) {
      throw new osapi_Storage_Exception("Couldn't store data");
    }
  }
